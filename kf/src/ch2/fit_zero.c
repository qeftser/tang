 ...
 * order least square filters to the equation f(x) = 3
 *
 * data will be written to 
 * fit_zero_measurements.dat
 * fit_zero_zeroth.dat
 * fit_zero_first.dat
 * fit_zero_second.dat
 *
 * 100 measurements from 0 to 10 in intervals of 0.1 will be taken
 * gaussian noise of mean 0 and sigma 1 will be added to the function
 */
...
int main(void) {
   ...
   FILE * measurements = fopen("dat/fit_zero_measurements.dat","w+");
   ...
   FILE * zeroth = fopen("dat/fit_zero_zeroth.dat","w+");
   ...
   /* write out the least squares line of best fit
    * for the first order                          */
   FILE * first = fopen("dat/fit_zero_first.dat","w+");
   ...
   /* write out the least squares line of best fit
    * for the first order                          */
   FILE * second = fopen("dat/fit_zero_second.dat","w+");
